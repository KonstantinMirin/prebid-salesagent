...
RESOLVED_IDENTITY_PER_FILE_CAP: dict[str, int] = {
    ...
    "tests/integration/test_account_resolution_error_codes.py": 0,
    "tests/integration/test_get_products_anonymous_pricing.py": 0,
    "tests/integration/test_get_products_auth_obligations.py": 0,
    "tests/integration/test_get_products_behavioral.py": 0,
    "tests/integration/test_get_products_policy_obligations.py": 0,
    "tests/integration/test_get_products_response_constraints.py": 0,
    "tests/integration/test_product_principal_access_pipeline.py": 0,
    "tests/integration/test_property_list_crud.py": 0,
    "tests/integration/test_property_list_validation.py": 0,
    "tests/unit/test_auth_requirements.py": 0,
}
