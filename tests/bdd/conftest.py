...
def pytest_generate_tests(metafunc: pytest.Metafunc) -> None:
    ...
    # HTTP, so dispatching e.g. UC-019 get_media_buys over e2e_rest 404s against
    # the server (the whole uc019 red cluster in the first in-network bdd_e2e
    # run). Only append e2e_rest when the UC actually exposes a REST endpoint.
