...
def _get_media_buy_delivery_impl(
    ...
    with MediaBuyUoW(tenant["tenant_id"]) as uow:
        ...
        # FIXME: delivery UoW should provide a product repo directly
                ...
                if not any(
                    ...
                    try:
                        ...
                        try:
                            ...
                            # FIXME: audit logging should use a repository
        ...
        # FIXME: delivery UoW should provide DeliveryRepository directly
