...
**36 of 40 scenarios assessed** — 4 outstanding.

Status: **GRADED** 16 · **NOT GRADED** 20

Action: **FIX-ASSERT** 4 · **REPIN** 10 · **RETAG** 20 · **TICKET** 2

Actions — `RETAG` tag claims a grading that does not apply to us (becomes `@schema-v3.1`, identifier preserved) · `REPIN` graded, `@source` stale/wrong/absent · `FIX-ASSERT` graded, scenario asserts the wrong thing · `TICKET` graded, production non-conformant, scenario stays dormant.
...
| `uc003-creativefate` | GRADED | **REPIN** | GRADED** — the `@storyboard-v3.1` tag is justified, but only for **half** of what the scenario title claims. |
...
| `uc002-inv-nomatch` | NOT GRADED | **RETAG** | NOT GRADED — prose only** (for the behaviour the scenario currently asserts). |
...
| `uc018-listall` | NOT GRADED | **RETAG** | NOT GRADED — undeclared gate.** The behaviour *is* graded at 3.1.1, but only inside the |
