...
> **Status: alpha.** A pre-1.0 implementation of AdCP 3.1.1, under active
> development. APIs still change between
...
Python SDK. Request/response shapes still move between spec releases, and SDK
bumps can change them. See
